...
export function ImageButton({
  ...
  return (
    <Link
      href={link}
      className="relative inline-block after:border-1 after:h-full after:absolute after:border-gray-500 after:border-solid"
    >
...
export default function Header2() {
  ...
  return (
    <div
      className="bg-white justify-center flex"
      style={{ width: '1236px', height: '146px', paddingTop: '35px' }}
    >
      <div>
        <div
          className="flex justify-center items-center"
          style={{ width: '1024px', height: '40px' }}
        >
          <Link href="/">
            <Image
              src={logoUrl}
