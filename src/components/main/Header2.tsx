...
const ImageButton = ({src, alt, width, height, title, link}: ImageButtonProps) => {
    return (
        <>
            <Link href={link} className="relative inline-block after:border-1 after:h-full after:absolute after:border-gray-500 after:border-solid">
                <div className="flex items-center ml-[30px]">
                    <Image
                        ...
                        height={height}
                        className="mr-[5px]"
                        layout="fixed" // 이미지 크기를 고정하는 layout 속성
                    ></Image>
...
export default function Header2() {
    ...
    return (
        <div className="bg-white justify-center flex" style={{width: '1236px', height: '146px', paddingTop: '35px'}}>
            <div>
                <div className="flex justify-center items-center" style={{width: '1024px', height: '40px'}}>
                    <Link href="/">
                        <Image
                            src={logoUrl}
                            alt="번개장터 로고 사진"
                    ...
                    <div className="flex items-center" style={{ width: '328px', height: '26px' }}>
                        {/* TODO 구분선 넣기 | */}
                        {/* 판매하기 버튼 */}
                        <ImageButton 
