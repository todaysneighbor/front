    ...
    return (
        <div style={{ width: '205.15px', height: '39px' }} className="flex">
            <div className="flex px-[15px] items-center">
                ...
                {/* 웹에서는 현재 페이지로 이동 */}
                <Link href='/'>
                    <div className="texxt-[#666666] text-[13px]">앱다운로드</div>
                </Link>
            </div>
            <div className="flex px-[15px] items-center">
                <Image src={starImgUrl} alt="즐겨찾기 로고" width={16} height={15} style={{ marginRight: '5px' }}></Image>
                    {/* 즐겨찾기 추가 방법 알려주는 alert 창 띄우기 */}
                    <div className="texxt-[#666666] text-[13px]"
                        onClick={() => {
